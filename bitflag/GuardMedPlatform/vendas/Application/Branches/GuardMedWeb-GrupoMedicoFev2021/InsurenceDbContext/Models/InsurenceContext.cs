...
{
    public partial class InsurenceContext : DbContext
    {
        ...
        public virtual DbSet<RevenuesForm> RevenuesForm { get; set; }
        ...
        public InsurenceContext(DbContextOptions<InsurenceContext> options) : base(options) { }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer(@"Server=69.162.77.150;Database=GuardMedInsurance_DEV;User Id=GuardMed;Password=YCnnb3Bk5pUg9Sgg;MultipleActiveResultSets=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Certificate>(entity =>
            {
                ...
                entity.Property(e => e.PlanPrice).HasDefaultValueSql("((0))");
                ...
                entity.Property(e => e.TaxaInquilini).HasDefaultValueSql("((0))");
            ...
            modelBuilder.Entity<RevenuesForm>(entity =>
            {
