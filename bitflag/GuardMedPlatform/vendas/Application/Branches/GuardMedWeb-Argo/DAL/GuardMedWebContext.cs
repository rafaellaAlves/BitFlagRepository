...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Especialidade>(entity =>
            {
                ...
                entity.Property(e => e.Grupo).HasDefaultValueSql("((0))");
            ...
            modelBuilder.Entity<EspecialidadePreco>(entity =>
            {
                ...
                entity.Property(e => e.PrecoAdmAnual).HasDefaultValueSql("((0))");

                entity.Property(e => e.PrecoAdmMensal).HasDefaultValueSql("((0))");

                entity.Property(e => e.PremioTotalAnual).HasDefaultValueSql("((0))");

                entity.Property(e => e.PremioTotalMensal).HasDefaultValueSql("((0))");
            });
            ...
            modelBuilder.Entity<PlanoSeguroProfissional>(entity =>
            {
                ...
                entity.Property(e => e.Franquia).HasDefaultValueSql("((0))");

                entity.Property(e => e.Nome)
                    .IsRequired()
                    .HasMaxLength(120);

                entity.Property(e => e.ValorCobertura).HasDefaultValueSql("((0))");
            });
