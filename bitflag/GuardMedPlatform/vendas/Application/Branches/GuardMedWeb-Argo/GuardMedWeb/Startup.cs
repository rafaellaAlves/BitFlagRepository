...
namespace GuardMedWeb
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<GuardMedWeb.BLL.SeguradoProfissional.EspecialidadeFunctions>();
            services.AddScoped<GuardMedWeb.BLL.SeguradoProfissional.PlanoSeguroProfissionalFunctions>();
            services.AddScoped<GuardMedWeb.BLL.SeguradoClinicaVeterinaria.SeguradoClinicaVeterinariaFunctions>();
            services.AddScoped<GuardMedWeb.BLL.Pagamento.PagamentoTipoFunctions>();
