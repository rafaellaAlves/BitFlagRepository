...
{
    public class SeguradoClinicaVeterinariaViewModel
    {
        ...
        public string PlanoExtensaoCobertura20PrecoTotal { get; set; }
        public string PlanoExtensaoCobertura30PrecoTotal { get; set; }
        public string PlanoExtensaoCobertura40PrecoTotal { get; set; }
        public string PlanoExtensaoCobertura50PrecoTotal { get; set; }
        ...
        public List<DAL.SeguradoProfissional> Funcionarios { get; set; }
        public List<DAL.Clt> CLTs { get; set; }
    }
}
