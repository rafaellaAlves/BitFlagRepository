...
namespace WEB.Models
{
    public class SeguradoProfissionalExtracaoViewModel
    {
        ...
        public int? GrupoMedicoPlataformaId { get; set; }
        public double? GrupoMedicoPlataformaComissao { get; set; }
        public int? GrupoMedicoEscritorioId { get; set; }
        public double? GrupoMedicoEscritorioComissao { get; set; }
