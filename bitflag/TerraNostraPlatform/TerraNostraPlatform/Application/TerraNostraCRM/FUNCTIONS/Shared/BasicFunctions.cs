...
namespace FUNCTIONS
{
    public abstract class BasicFunctions<TEntity, TViewModel> : IBasicFunctions<TEntity, TViewModel>
        where TEntity : class
...

    {
        ...
        public BasicFunctions(DB.TerraNostraContext context, string entityIdPropertyName)
        {
