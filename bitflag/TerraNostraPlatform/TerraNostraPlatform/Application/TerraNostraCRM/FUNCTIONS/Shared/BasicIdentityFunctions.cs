...
namespace FUNCTIONS
{
    public abstract class BasicIdentityFunctions<TEntity, TViewModel> : IBasicFunctions<TEntity, TViewModel>
        where TEntity : class
        where TViewModel : class

    {
        protected TerraNostraIdentityDbContext.ApplicationDbContext context;
        ...
        public BasicIdentityFunctions(TerraNostraIdentityDbContext.ApplicationDbContext context, string entityIdPropertyName)
        {
