...
namespace AMaisImob_WEB.Controllers
{
    ...
    public class ContractualGuaranteeController : Controller
    {
        ...
        private void GetListFilter(int statusId, int userId, string search, int? realEstateAgencyId, int? realEstateId, bool priceQuoteStatus, bool approvedStatus, bool refusedStatus, bool analyzeStatus, bool pendencyStatus, bool waitingEmissionStatus, bool issuedStatus, bool endOfTermStatus, bool cancelStatus, bool all, ref string query, ref List<SqlParameter> parameters)
        {
        ...
        public async Task<IActionResult> GetTotalPriceFromList(Models.DataTablesAjaxPostModel filter, int statusId, string search, int? realEstateAgencyId, int? realEstateId, bool priceQuoteStatusId, bool approvedStatusId, bool refusedStatusId, bool analyzeStatusId, bool pendencyStatusId, bool waitingEmissionStatusId, bool issuedStatusId, bool renewStatusId, bool endOfTermStatusId, bool cancelStatusId, bool notRenewedStatus, bool all)
        {
            ...
            GetListFilter(statusId, user.Id, search, realEstateAgencyId, realEstateId, priceQuoteStatusId, approvedStatusId, refusedStatusId, analyzeStatusId, pendencyStatusId, waitingEmissionStatusId, issuedStatusId, endOfTermStatusId, cancelStatusId, all, ref query, ref parameters);
