...
namespace AMaisImob_WEB.BLL.Shared
{
    public abstract class BLLBasicListFunctions<TEntity, TViewModel>
        where TEntity : class
...

    {
        ...
        public BLLBasicListFunctions(AMaisImob_DB.Models.AMaisImob_HomologContext context, string entityIdPropertyName)
        {
