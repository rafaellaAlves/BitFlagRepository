...
{
    public class ProductAssistanceFunctions : BLLBasicFunctions<AMaisImob_DB.Models.ProductAssistance, AMaisImob_WEB.Models.ProductAssistanceViewModel>
    {
        public ProductAssistanceFunctions(AMaisImob_HomologContext context)
