...
namespace AMaisImob_WEB.Controllers
{
    ...
    public class SeasonController : Controller
    {
        ...
        public SeasonController(AMaisImob_DB.Models.AMaisImob_HomologContext context)
        {
        ...
        {
            IEnumerable<AMaisImob_WEB.Models.SeasonViewModel> d = seasonFunctions.GetDataViewModel(seasonFunctions.GetDataFiltered(filter, out int recordsTotal, out int recordsFiltered, "IsDeleted = 0", whereParameter: null));
