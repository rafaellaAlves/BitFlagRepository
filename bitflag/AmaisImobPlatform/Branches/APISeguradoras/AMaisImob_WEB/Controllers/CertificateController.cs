...
namespace AMaisImob_WEB.Controllers
{
    ...
    public class CertificateController : Controller
    {
        ...
        public async Task<IActionResult> _Manage(Models.CertificateViewModel model)
        {
            ...
            {
                await mailFunctions.SendAsync("A+Imob - Criação de certificado não aprovado.", NonApprovedCertificateEmailText(model), new List<string> { "atendimento@amaisimob.com.br" }, null);
            }
