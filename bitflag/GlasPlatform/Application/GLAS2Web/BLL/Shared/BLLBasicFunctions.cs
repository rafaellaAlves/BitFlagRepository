...
namespace BLL
{
...

    {
        ...
        public BLLBasicFunctions(DAL.GLAS2Context context, string entityIdPropertyName)
        {
        ...
        public IQueryable<TEntity> GetDataAsNoTracking(Expression<Func<TEntity, bool>> _where = null) => _where == null? this.dbSet.AsNoTracking() : this.dbSet.Where(_where).AsNoTracking();
