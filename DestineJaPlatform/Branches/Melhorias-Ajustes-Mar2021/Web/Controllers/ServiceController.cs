...
#if DEBUG
            emailServices.Send($"O.S Assinada - O.S \"{entity.Code}\" - {client.Name}", html_Admin, new List<string> { "sarah.reggiani@bitflag.systems", "joao.gregorio@bitflag.systems" });
#else
            emailServices.Send($"O.S Assinada - O.S \"{entity.Code}\" - {client.Name}", html_Admin, new List<string> { "comercial@destineja.com.br", "financeiro@destineja.com.br", "operacional@destineja.com.br" });
#endif
            #endregion
        }
...
#if DEBUG
            await SendServiceEmail(id, "", "", "joao.gregorio@bitflag.systems;sarah.reggiani@bitflag.systems");
#else
            await SendServiceEmail(id, entity.ContactEmail, "", "operacional@destineja.com.br");
#endif
