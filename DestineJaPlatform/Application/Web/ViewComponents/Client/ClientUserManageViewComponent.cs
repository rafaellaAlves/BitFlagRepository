...
{
    public class ClientUserManageViewComponent : ViewComponent
    {
        private readonly ClientUserServices clientUserServices;
        private readonly UserService userService;

        public ClientUserManageViewComponent(ClientUserServices clientUserServices, UserService userService)
        {
