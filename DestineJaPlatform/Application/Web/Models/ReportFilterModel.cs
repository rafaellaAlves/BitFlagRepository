...
namespace Web.Models
{
    public class ReportFilterModel
    {
        ...
        public static ReportFilterModel SearchFilter(object arguments = null, int? colSize = null) => new ReportFilterModel(typeof(ViewComponents.Report.Filter.SearchFilterViewComponent), arguments, colSize);
        public static ReportFilterModel OptionalStartAndEndDateFilter(object arguments = null, int? colSize = null) => new ReportFilterModel(typeof(ViewComponents.Report.Filter.OptionalStartAndEndDateViewComponent), arguments, colSize);
