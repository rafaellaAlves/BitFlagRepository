...
namespace DTO.Utils
{
    public static class DoubleExtesions
    {
        ...
        public static string ToWeightPtBr(this double? me) => !me.HasValue ? null : me % 1 == 0 ? me.Value.ToString() : (Math.Truncate(me.Value * 10) / 10).ToString("#0.0", CultureInfo.GetCultureInfo("pt-BR"));
        public static string ToWeightPtBr(this double me) => me % 1 == 0 ? me.ToString() : (Math.Truncate(me * 10) / 10).ToString("#0.0", CultureInfo.GetCultureInfo("pt-BR"));
